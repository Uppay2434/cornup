...
// This a login/signup page for Supabase Auth, with GitHub OAuth and email magic link.
  ...
  return (
    <main className="p-8 md:p-24" data-theme={config.colors.theme}>
      ...
      <div className="space-y-8 max-w-xl mx-auto">
        ...
        <button
          className="btn btn-block flex items-center justify-center space-x-2"
          onClick={(e) =>
